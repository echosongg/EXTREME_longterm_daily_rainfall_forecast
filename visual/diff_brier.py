...
levels = {}
levels["95"] = [-0.1, -0.01, -0.005, -0.003, -0.002, -0.001, 0, 0.001, 0.002, 0.003, 0.005, 0.01, 0.1]
levels["99"] = [-0.02,-0.005,-0.001,-0.0005, -0.0003, -0.0001, 0, 0.0001, 0.0003, 0.0005, 0.001,0.005, 0.02]
levels["995"] = [-0.02,-0.01,-0.001,-0.0005, -0.0001, -0.00002, 0, 0.00002, 0.0001, 0.0005, 0.001,0.01, 0.02]
#0.0094
def draw(my_model_data, compare_data, lon, lat, pct, title):
    ...
    filtered_data = data_values[(data_values <= 0.01)]
    # 使用 .values 将 DataArray 转换为 numpy 数组，再调用 flatten()
    plt.hist(filtered_data, bins=200, alpha = 0.7, color='blue', edgecolor='black')
    plt.axvline(0, color='red', linestyle='dashed', linewidth=1)
    plt.title(f"{title} - Data Diff Histogram")
    plt.xlabel('Difference Values')
    plt.ylabel('Frequency')

    # 保存直方图图片
    save_path_hist = f"/home/599/xs5813/EXTREME/visual/histogram_{title.replace('/', '_')}.png"
...
#diff(2018,1,method="QM", pct="99")
diff_average(2006,0,41,method="DESRGAN", pct="99")
diff_average(2007,0,41,method="DESRGAN", pct="99")
diff_average(2018,0,41,method="DESRGAN", pct="99")

diff_average(2006,0,41,method="climatology", pct="99")
diff_average(2007,0,41,method="climatology", pct="99")
diff_average(2018,0,41,method="climatology", pct="99")

diff_average(2006,0,41,method="QM", pct="99")
diff_average(2007,0,41,method="QM", pct="99")
diff_average(2018,0,41,method="QM", pct="99")

diff_average(2006,0,41,method="DESRGAN", pct="95")
diff_average(2007,0,41,method="DESRGAN", pct="95")
diff_average(2018,0,41,method="DESRGAN", pct="95")

diff_average(2006,0,41,method="climatology", pct="95")
diff_average(2007,0,41,method="climatology", pct="95")
diff_average(2018,0,41,method="climatology", pct="95")

diff_average(2006,0,41,method="QM", pct="95")
diff_average(2007,0,41,method="QM", pct="95")
diff_average(2018,0,41,method="QM", pct="95")

diff_average(2006,0,41,method="DESRGAN", pct="995")
diff_average(2007,0,41,method="DESRGAN", pct="995")
diff_average(2018,0,41,method="DESRGAN", pct="995")

diff_average(2006,0,41,method="climatology", pct="995")
diff_average(2007,0,41,method="climatology", pct="995")
diff_average(2018,0,41,method="climatology", pct="995")

diff_average(2006,0,41,method="QM", pct="995")
diff_average(2007,0,41,method="QM", pct="995")
diff_average(2018,0,41,method="QM", pct="995")