...
def main(year, days):
    ...
    print("percentile 995 is : ", percentile_995)
    ...
    def compute_metrics(sr, hr, args):
        ...
        metrics = {
            ...
            "relative_bias": bias_relative(sr, hr, constant=3),
    ...
    for lead in range(0, days):
        ...
        results = {metric: [] for metric in ["mae", "mae_mean", "mae_median", "bias", "bias_median", "rmse", "skil", "relative_bias", "Brier_0", "Brier_95", "Brier_99","Brier_995"]}
