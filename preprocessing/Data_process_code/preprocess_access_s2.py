...
e_list = ['e01','e02','e03','e04','e05','e06','e07','e08','e09']
print(e_list)
for e_num in e_list:
    for file in (os.listdir("/g/data/ux62/access-s2/hindcast/raw_model/atmos/pr/daily/" + e_num + "/")):
        #if int(file[6:10]) < 1990 or int(file[6:10]) > 2005:
        #    continue
        if int(file[6:10]) not in [2011, 2019, 2020, 2021]:
            continue
        ...
        # save to netcdf
        # Explanation [3]
        ds_total.to_netcdf("/scratch/iu60/xs5813/Processed_data_bigger/" + e_num + "/" + file)
        ds_raw.close()
